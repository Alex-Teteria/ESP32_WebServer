...
v.3 18.07.2023  
Тестова реалізація пересилання інформації (в UTF-8) за допомогою криптоалгоритму RSA.  
...
Аналог цього - метод цілих чисел Python int.from_bytes(bytes, byteorder='big', *, signed=False),  
